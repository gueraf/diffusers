...
class CacheMixin:
    ...
    def disable_cache(self) -> None:
        ...
        from ..hooks.rolling_kv_cache import _ROLLING_KV_CACHE_CROSS_ATTN_HOOK, _ROLLING_KV_CACHE_SELF_ATTN_HOOK
        ...
        if isinstance(self._cache_config, FasterCacheConfig):
            ...
            registry.remove_hook(_ROLLING_KV_CACHE_SELF_ATTN_HOOK, recurse=True)
            registry.remove_hook(_ROLLING_KV_CACHE_CROSS_ATTN_HOOK, recurse=True)
